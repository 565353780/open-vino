...
public:
	...
	vector<vector<double>> get_bbox_xyxy(vector<vector<vector<double>>> json_dict, double conf_thresh, double expand_coefficient, vector<int> keypoints_idx_used);
	vector<vector<double>> get_bbox_xywh(vector<vector<vector<double>>> json_dict, double conf_thresh, double expand_coefficient, vector<int> keypoints_idx_used);
	vector<vector<double>> get_bbox_tlwh(vector<vector<vector<double>>> json_dict, double conf_thresh, double expand_coefficient, vector<int> keypoints_idx_used);
